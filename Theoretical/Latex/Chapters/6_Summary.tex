...
In my opinion, this is preferable because I would become confused about which variables to call and would benefit from better file management for each component of the game. 
\begin{figure}[H]
	\centering
